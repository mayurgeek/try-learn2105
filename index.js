...
app.get("/version", (req, res) => {
  ...
  // connection
  res.send({
    "latest_update": dat, "latest_commit": "check  -  server good 04/09/2023 - 10:10"
  })
